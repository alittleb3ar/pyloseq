...
from pyloseq import (OtuTable, Phyloseq, PhyTree, RefSeq, SampleData, TaxTable,
                     filter_taxa, kOverA, merge_phyloseq, merge_samples,
                     merge_taxa, prune_samples, prune_taxa, psmelt,
                     rarefy_even_depth, subset_samples, subset_taxa, tax_glom,
                     taxa_filter_mask, tip_glom, transform_sample_counts)
